...
import { Alert, ListItemText, Card, Button, LinearProgress } from '@mui/material';

export default class DesktopAccountPage extends Component {
    static propTypes = {
      user: PropTypes.any,
    };
    constructor(props) {
    ...
    render() {
        ...
        const resetPasswordRequest = (event) => {
            ...
            fetch(`https://api.hbcreations.io/api/user/forgotPassword?email=${user?.email}`, {
              method: 'POST'
            })
            .then(res => {
              if (res.status === 201) {

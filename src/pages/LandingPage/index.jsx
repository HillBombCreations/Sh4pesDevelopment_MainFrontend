    ...
    return (
      <div id="page-container">
        <div id="content-wrap" style={{ padding: '10px 20vw 10px 20vw' }}>
          <header style={{ display: 'flex', alignItems: 'center', marginBottom: 'auto', minHeight: '60px' }}>
            <img src="/assets/HBCreations.png" alt="HB Creations Banner" style={{ position: 'absolute', width: '150px', marginRight: 'auto', top: '10px', left: '20%' }} />
            <Tabs pathname={pathname} />
          </header>
          <div style={{ textAlign: 'left', paddingBottom: '50px', paddingTop: '50px' }}>
            <h1 style={{ color: '#3780ff' }}>Elevate Your Online Presence</h1>
            <h2>Where Innovation Meets Talent</h2>
              ...
              <p>
                ...
                {/* At HB Creations, we understand the power of technology to transform businesses and drive innovation. 
                That's why we've built a community of top-tier freelance developers and designers who are ready to bring your ideas to life. 
                Whether you're a startup in need of a web app, an established company seeking a mobile solution, or an individual entrepreneur 
                with a dream, we've got you covered. */}
              </p>
            <br />
            <h3>Our Mission</h3>
            <p>
